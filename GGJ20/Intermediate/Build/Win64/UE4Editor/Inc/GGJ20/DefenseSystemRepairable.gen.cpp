...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ADefenseSystemRepairable_Statics::NewProp_NeedleMesh_MetaData[] = {
		{ "Category", "DefenseSystemRepairable" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/DefenseSystemRepairable.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ADefenseSystemRepairable_Statics::NewProp_NeedleMesh = { "NeedleMesh", nullptr, (EPropertyFlags)0x00400000000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADefenseSystemRepairable, NeedleMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ADefenseSystemRepairable_Statics::NewProp_NeedleMesh_MetaData, ARRAY_COUNT(Z_Construct_UClass_ADefenseSystemRepairable_Statics::NewProp_NeedleMesh_MetaData)) };
	...
	IMPLEMENT_CLASS(ADefenseSystemRepairable, 2808846137);
